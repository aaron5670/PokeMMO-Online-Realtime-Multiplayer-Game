...
let cursors, map, tileset, belowLayer, worldLayer, grassLayer, aboveLayer, spawnPoint, camera, player, socketKey;


export var RouteScene = {
    key: "route1",

    preload: function(){
        console.log("RouteScene preload");
    ...
    create: function(){
        console.log("RouteScene create");

        this.map = this.make.tilemap({key: "route1"});
        ...
        // var button = this.add.image(50, 1100, "button")
        // button.setInteractive();
        //
        // button.on('pointerdown', function(){
        //     console.log("moving to the game scene");
        //     this.scene.switch("exampleScene2");
        // }, this);
    },
